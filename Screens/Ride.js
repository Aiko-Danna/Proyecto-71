...
export default class RideScreen extends Component {
  ...
  getCameraPermissions = async () => {
    ...
    this.setState({
      /*status === "granted" es true cuando el usuario concede el permiso
          status === "granted" es false cuando el usuario no concede el permiso
        */
  ...
  assignBike = () => {
    console.log("Rentaste la bicicleta durante 1 hora. Disfruta tu viaje");
  };
    ...
    return (
      <View style={styles.container}>
        <View style={styles.upperContainer}>
          ...
          <Text style={styles.subtitle}>Viaje ecológico</Text>
        </View>
